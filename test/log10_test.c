 ...
 */
static scalar_t __manual_log10__(scalar_t x)
{
  return log10(x);
}
 ...
 */
static void scalar_log_test(void unused **state)
{
  scalar_test(&__log10__);
}
...
int main(void)
{
  const struct CMUnitTest tests[] = {
    cmocka_unit_test(scalar_log10_test),
    //cmocka_unit_test(vector_log_test),
  };

  init_test_cache(&__manual_log10__);
