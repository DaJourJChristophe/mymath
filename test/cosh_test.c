 ...
 */
static scalar_t __manual_cosh__(scalar_t x)
{
  return cosh(x);
}
 ...
 */
static void scalar_cosh_test(void unused **state)
{
  scalar_test(&__cosh__);
}
 ...
 * @param state A multidimensional list of objects used by CMocka.
 */
// static void vector_cosh_test(void unused **state)
// {
// }
...
int main(void)
{
  const struct CMUnitTest tests[] = {
    cmocka_unit_test(scalar_cosh_test),
    //cmocka_unit_test(vector_cosh_test),
  };

  init_test_cache(&__manual_cosh__);
